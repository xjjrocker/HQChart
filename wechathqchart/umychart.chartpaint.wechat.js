...
function ChartMultiText() 
{
    ...
    this.Texts = [];  //[ {Date, Time:, Value:, Text:, Color:, BGColor:,Margin={ Top:5, Bottom:5, Left:5, Right:5, XOffset:5, YOffset:-4 }, Font: , Baseline:, Line:{ Color:, Dash:[虚线点], KData:"H/L", Offset:[5,10], Width:线粗细 } } ]
